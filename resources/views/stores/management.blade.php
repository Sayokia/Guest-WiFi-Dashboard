                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="ance_en" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                            <div class="form-group{{ $errors->has('name_en') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="name_en" id="input-name_en" class="form-control form-control-alternative{{ $errors->has('name_en') ? ' is-invalid' : '' }}" placeholder="{{ __('Your Store Announcement in English') }}" value="{{ old('name_en', $info->name_en) }}" required autofocus>
                                        ...
                                        <div class="tab-pane fade" id="ance_zh" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
                                            <div class="form-group{{ $errors->has('name_zh') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="name_zh" id="input-name_zh" class="form-control form-control-alternative{{ $errors->has('name_zh') ? ' is-invalid' : '' }}" placeholder="{{ __('Your Store Announcement in Chinese') }}" value="{{ old('name_en', $info->name_zh) }}" required autofocus>
                                        ...
                                        <div class="tab-pane fade" id="ance_fr" role="tabpanel" aria-labelledby="tabs-icons-text-3-tab">
                                            <div class="form-group{{ $errors->has('name_fr') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="name_fr" id="input-name_fr" class="form-control form-control-alternative{{ $errors->has('name_fr') ? ' is-invalid' : '' }}" placeholder="{{ __('Your Store Announcement in French') }}" value="{{ old('name_en', $info->name_fr) }}" required autofocus>
                                        ...
                                        <div class="tab-pane fade" id="ance_jp" role="tabpanel" aria-labelledby="tabs-icons-text-3-tab">
                                            <div class="form-group{{ $errors->has('name_jp') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="name_jp" id="input-name_jp" class="form-control form-control-alternative{{ $errors->has('name_jp') ? ' is-invalid' : '' }}" placeholder="{{ __('Your Store Announcement in Japaneses') }}" value="{{ old('name_jp', $info->name_jp) }}" required autofocus>
                                        ...
                                        <div class="tab-pane fade" id="ance_kr" role="tabpanel" aria-labelledby="tabs-icons-text-3-tab">
                                            <div class="form-group{{ $errors->has('name_kr') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="name_kr" id="input-name_kr" class="form-control form-control-alternative{{ $errors->has('name_kr') ? ' is-invalid' : '' }}" placeholder="{{ __('Your Store Announcement in Korean') }}" value="{{ old('name_kr', $info->name_kr) }}" required autofocus>
